...
class LessonATest {
    ...
    void e5() {
        ...
        assertEquals(answer%2 == 0, LessonA.e5());
        assertEquals(answer%3 == 0, LessonA.e5());
        assertEquals(answer%7 == 0, LessonA.e5());
        assertEquals(answer < 55, LessonA.e5());
    }
    ...
    void e9() {
        ...
        assertTrue(LessonA.e9(true, false, true, false));
        assertTrue(LessonA.e9(false, true, false, true));
    ...
    void e14() {
        int [] a = new int [] {1, 4, 6, 2, 4, 1, 5, 2, 7, 1, 8, 1};
        int [] aAnswer = new int [] {1, 1, 6, 6, 4, 4, 5, 5, 7, 7, 8 , 8};
        int [] b = new int [] {4, 3, 1, 53, 2, 55};
    ...
    void e15() {
        ...
        LessonA.e15(a);
        LessonA.e15(b);
        assertArrayEquals(a, aAnswer);
        assertArrayEquals(b, bAnswer);
    }
}